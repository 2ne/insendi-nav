...
const Button = forwardRef((props, ref) => {
  ...
  const buttonClasses = {
    base:
      "transition-all duration-75 shrink-0 group/button inline-flex items-center justify-center whitespace-nowrap shadow-sm border outline-none",
    size: {
      small:
    ...
    preset: {
      primary:
        "bg-primary text-white border-primary hover:bg-primary-dark focus-visible:border-primary-darkest",
      "primary-outline":
        "bg-white text-primary border-primary hover:bg-primary-lightest focus-visible:border-primary-darkest",
      secondary:
        "bg-white text-neutral-700 border-neutral-300 hover:bg-neutral-100 focus-visible:border-primary",
      white:
        "bg-white text-neutral-700 border-transparent hover:bg-neutral-100 focus-visible:border-primary",
      plain:
        "shadow-none text-neutral-700 border-transparent hover:bg-neutral-100 focus-visible:border-primary"
    },
    iconOnly: {
      ...
      >
        {children && (
          <span
            className={
              iconOnly
                ? "transition-transform duration-75 group-hover/button:scale-90"
                : " "
            }
          >
            {children}
